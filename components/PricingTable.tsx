...
export default function PricingTable({
  ...
  subheadline = 'Choose the plan that fits your stage and unlock higher conversion rates.',
  tiers = [],
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {tiers.map(function (tier, i) {
            return (
              <Card
                key={i}
                className={'relative flex flex-col rounded-xl ' + (tier.highlighted ? 'scale-105 border-primary ring-2 ring-primary' : 'border')}
              >
                {tier.highlighted && (

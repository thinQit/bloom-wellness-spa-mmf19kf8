...
export default function HeroAurora({
  badge = 'Trusted by fast-growing SaaS teams',
  headline = 'Turn more visitors into customers with a high-converting landing page',
  subheadline = 'Launch conversion-focused pages in days, not weeks, with messaging, design, and CTAs built to drive revenue.',
